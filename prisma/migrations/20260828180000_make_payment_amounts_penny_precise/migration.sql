...
INSERT INTO "new_Payment" ("amountGbp", "confirmedAt", "createdAt", "id", "quoteId", "status", "stripeCheckoutUrl", "stripePaymentIntentId", "tenderId", "type", "userId") SELECT "amountGbp", "confirmedAt", "createdAt", "id", "quoteId", "status", "stripeCheckoutUrl", "stripePaymentIntentId", "tenderId", "type", "userId" FROM "Payment";
DROP TABLE "Payment";
