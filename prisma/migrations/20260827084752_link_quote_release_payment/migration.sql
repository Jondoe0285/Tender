...
INSERT INTO "new_Payment" ("amountGbp", "confirmedAt", "createdAt", "id", "status", "stripePaymentIntentId", "type", "userId") SELECT "amountGbp", "confirmedAt", "createdAt", "id", "status", "stripePaymentIntentId", "type", "userId" FROM "Payment";
DROP TABLE "Payment";
