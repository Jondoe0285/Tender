            ...
            <div key={account.id} className="flex flex-col gap-4 px-6 py-5 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-col items-stretch gap-3 lg:items-end">
                <a
                  ...
                  className="inline-flex min-h-10 items-center justify-center rounded-md bg-foundation-navy px-4 py-2 text-xs font-semibold text-site-white shadow-soft transition hover:bg-foundation-navy/90 lg:min-w-32"
                >
                  View profile
                </a>
