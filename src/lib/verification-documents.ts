...
export const VERIFICATION_DOCUMENT_TYPES: readonly VerificationDocumentDefinition[] = [
  { type: 'CERTIFICATE_OF_INCORPORATION', label: 'Certificate of Incorporation', description: 'Optional evidence for Providers operating as an incorporated legal entity.', appliesTo: 'all', required: false },
  { type: 'PUBLIC_LIABILITY_INSURANCE', label: 'Public Liability Insurance', description: 'Optional supporting evidence of public liability cover.', appliesTo: ['Materials', 'Waste', 'Plant Hire', 'Contractor Services', 'Professional Services'], required: false },
  { type: 'EMPLOYERS_LIABILITY_INSURANCE', label: 'Employers Liability Insurance', description: 'Optional evidence where the business employs workers; upload it when legally applicable.', appliesTo: 'all', required: false },
  { type: 'WASTE_CARRIERS_LICENCE', label: 'Waste Carriers Licence', description: 'Required for Waste Providers who transport or carry controlled waste.', appliesTo: ['Waste'], required: true },
  { type: 'PROFESSIONAL_QUALIFICATIONS', label: 'Evidence of Qualifications', description: 'Optional supporting evidence of competence for Professional Services.', appliesTo: ['Professional Services'], required: false },
  { type: 'PROFESSIONAL_INDEMNITY_INSURANCE', label: 'Professional Indemnity Insurance', description: 'Optional supporting evidence for Professional Services with professional liability exposure.', appliesTo: ['Professional Services'], required: false },
