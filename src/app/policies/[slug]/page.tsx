  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'The platform defines six verification statuses for documentation and assessment purposes:\n\n1. Unverified: No approved verification evidence is recorded on the platform (Banner label: Unverified).\n2. Sole trader automated assessment: A PDF text check confirmed self-employment evidence (HMRC UTR confirmation, SA302 tax calculation, VAT registration certificate, CIS registration proof, insurance, bank statement, invoices, quotations/contracts, trade body membership, or trading activity evidence). This is not a live HMRC or insurer lookup (Banner label: Verified).\n3. Incorporated automated assessment: A PDF text check confirmed legal entity standing, mandatory Certificate of Incorporation (required for Limited Company, LLP, and PLC company types), and required service evidence such as a Waste Carriers Licence where Waste is selected. Public liability insurance is not required for the Verified badge unless the Owner has marked it required (Banner label: Verified).\n4. Enhanced Bronze Verification: A paid professional Health & Safety review was recorded for legal requirements such as permits, insurances, and competent advice (Banner label: Bronze).\n5. Enhanced Silver Verification: A paid professional Health & Safety review was recorded for Bronze criteria plus industry-specific employee and managerial training (Banner label: Silver).\n6. Enhanced Gold Verification: A paid professional Health & Safety review was recorded for Bronze and Silver criteria plus either a comprehensive management system or validated SSIP membership (Banner label: Gold).\n\nA Provider purchases Bronze, Silver, or Gold as separate products. The auditor may award the purchased tier or a lower tier. Enhanced status means a professional review was recorded; Trade Tender does not itself inspect permits, training records, or SSIP membership for those products.',
      },
      {
        heading: 'Evidence and review process',
        content: 'Providers submit evidence according to their declared company type and service scope. For incorporated company types (Limited Company, LLP, PLC), uploading a Certificate of Incorporation is mandatory. For sole traders, uploading self-employment evidence (either one strong document or two moderate documents) is required. Automated verification is a PDF text check only. Trade Tender may decline verification where evidence is incomplete, unreadable, or inconsistent. There is no human review queue on the automated upload path.',
      },
      {
