...
export default function RetailerProfilePage() {
  ...
  async function removeTeamMember(member: TeamMember) {
    if (!window.confirm(`Remove ${member.user.contactName} from this retailer space?`)) return;
  ...
  if (!profile) return <AppShell role="retailer" title="Profile"><p className="text-sm text-attention">Retailer profile not found.</p></AppShell>;
