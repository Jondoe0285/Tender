...
const emptyProfile: Profile = {
  firstName: '', lastName: '', email: '', phoneNumber: '', companyName: null, branchIdentifier: null, services: [], serviceProvisions: [], operatingLocations: [], tradeTenderId: null, isPrimaryUser: false, additionalUsers: [], warnings: [],
};
