...
export async function GET() {
  try {
    ...
    const profile = await prisma.retailerProfile.findUnique({ where: { userId: user.id }, select: { categories: true, independentReviewStatus: true, independentReviewPurchasedAt: true, independentReviewDecidedAt: true, independentReviewNote: true } });
