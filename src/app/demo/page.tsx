    ...
    <div className="flex min-h-screen flex-col bg-light-grey">
      ...
      <main id="main-content" className="flex-1">
        <section className="mx-auto max-w-3xl px-6 py-16 sm:px-10">
          <p className="text-xs font-semibold uppercase tracking-widest text-steel-blue">For buyers and suppliers</p>
          <h1 className="mt-4 font-heading text-4xl font-bold text-foundation-navy">Request a demo</h1>
          <p className="mt-4 text-lg text-concrete-grey">Tell us the buying or supplying job you need to run. We will walk the tender, quote, and award path — not a generic product tour.</p>
          <Card className="mt-8">
