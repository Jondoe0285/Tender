...
After the Provider pays one tender unlock fee, the platform should release the full tender job and every package so they can assess the complete opportunity and quote for every part within their capability. The Provider may price each tender item or mark it unavailable. There are no additional unlock fees for other packages in the same tender. The platform should record the unlock event against the tender identifier, Provider account, payment status, date, time, and any Super User override.
...
> Resolved: the Super User has confirmed the platform keeps its current approved brand palette and identity ([docs/branding/Trade_Tender_Brand_Guide_Construction_Edition.pdf](branding/Trade_Tender_Brand_Guide_Construction_Edition.pdf) and [docs/branding/TradeTender-Brand-Rules.md](branding/TradeTender-Brand-Rules.md)). The colour palette and personality proposed below are **not adopted**; they are retained in this document for reference only. See Baseline Change Notes.
...
8. **Brand palette — RESOLVED, keep current brand.** The platform keeps its current approved brand palette and identity ([docs/branding/Trade_Tender_Brand_Guide_Construction_Edition.pdf](branding/Trade_Tender_Brand_Guide_Construction_Edition.pdf), [docs/branding/TradeTender-Brand-Rules.md](branding/TradeTender-Brand-Rules.md)). Section 11's proposed Construction Navy/Safety Orange palette is not adopted.
