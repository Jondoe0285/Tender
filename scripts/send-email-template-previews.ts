...
const templates: Array<[string, EmailTemplate]> = [
  ...
  ['new registration', newRegistrationTemplate({ role: 'USER', email: 'preview@example.test', contactName: 'Preview User', companyName: 'Preview Construction Ltd' })],
  ...
  ['admin-created account', accountCreatedByAdminTemplate({ role: 'USER', contactName: 'Preview User', companyName: 'Preview Builders Ltd', resetLink: previewLink, expiresIn: '24 hours' })],
